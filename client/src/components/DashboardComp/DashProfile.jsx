...
import { updateStart, updateFailure, updateSuccess, deleteError, deleteStart, deleteSuccess } from '../../redux/user/userSlice'
...
export default function DashProfile() {
    ...
    console.log(imageFileUploadProgress, imageFileUploadError)//thi line
    ...
    return (
        <div className='max-w-lg mx-auto'>
            ...
            text-3xl'>Profile</h1>
            <form className='flex flex-col p-3 w-full gap-4' onSubmit={handleSubmit}>
                <input

                    type='file' accept='image/*' onChange={handleImageChange} ref={filepickerref} hidden />
            ...
            ' onClick={() => filepickerref.current.click()}>
                    ...
                    <img src={imageFileUrl || currentUser.profilePicture}
                        className={`rounded-full w-full h-full object-cover border-8 border-[lightgray] ${imageFileUploadProgress &&
                            imageFileUploadProgress < 100 && imageFileUploading &&
                            'opacity-60'
                            }`} ></img>
            ...
            {
                updateusererror && <Alert color='failure'>
                    {updateusererror}
                </Alert>
            }
